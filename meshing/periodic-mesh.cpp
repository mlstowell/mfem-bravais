...
int main (int argc, char *argv[])
{
   ...
   switch (lattice_type)
   {
      ...
      case 2:
      {
         ...
         a[1][0] =  0.0; a[1][1] =  1.0; a[1][2] =  0.0;
         a[2][0] =  0.0; a[2][1] =  0.0; a[2][2] =  1.0;
         a[3][0] =  0.5; a[3][1] =  0.5; a[3][2] =  0.5;
         a[4][0] = -0.5; a[4][1] =  0.5; a[4][2] =  0.5;
         a[5][0] = -0.5; a[5][1] = -0.5; a[5][2] =  0.5;
         a[6][0] =  0.5; a[6][1] = -0.5; a[6][2] =  0.5;
      }
      break;
      case 3:
      {
         ...
         a[1][0] =  0.5; a[1][1] = -0.5; a[1][2] =  0.0;
         a[2][0] =  0.5; a[2][1] =  0.0; a[2][2] =  0.5;
         a[3][0] =  0.0; a[3][1] =  0.5; a[3][2] =  0.5;
         a[4][0] = -0.5; a[4][1] =  0.0; a[4][2] =  0.5;
         a[5][0] =  0.0; a[5][1] = -0.5; a[5][2] =  0.5;
      }
      break;
      case 4:
      {
         ...
         a[0][0] =  1.0; a[0][1] =  0.0; a[0][2] =  0.0;
         a[1][0] =  0.5; a[1][1] =  0.8660254037844386; a[1][2] =  0.0;
         a[2][0] =  0.5; a[2][1] = -0.8660254037844386; a[2][2] =  0.0;
   ...
   */
   ...
   for (unsigned int i=0; i<a.size(); i++)
   {
      ...
      for (mxyz=c2v.begin(); mxyz!=c2v.end(); mxyz++)
      {
         // double x = todouble(d,mxyz->first) + a[i][0];
         // int xi = mxyz->first + toint(d,a[i][0]);
         // cout << "xi " << xi << endl;
         ...
         for (myz=mxyz->second.begin(); myz!=mxyz->second.end(); myz++)
         {
            // double y = todouble(d,myz->first) + a[i][1];
            // int yi = myz->first + toint(d,a[i][1]);
            // cout << "yi " << yi << endl;
            ...
            for (mz=myz->second.begin(); mz!=myz->second.end(); mz++)
            {
               // double z = todouble(d,mz->first) + a[i][2];
               // int zi = mz->first + toint(d,a[i][2]);
               // cout << "zi " << zi << endl;
