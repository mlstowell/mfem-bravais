...
void trans(Mesh * mesh, double a, double c);
...
void trans_trunc_dod(Mesh * mesh, double a, double c);
void trans_elong_dod(Mesh * mesh, double a, double c);

void trans(Mesh * mesh, double a, double c)
{
   if ( c < sqrt(2.0) * a )
   {
      trans_trunc_dod(mesh, a, c);
   }
   else
   {
      trans_elong_dod(mesh, a, c);
   }
}
