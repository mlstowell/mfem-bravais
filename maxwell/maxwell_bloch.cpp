...
void
MaxwellBlochWaveEquation::GetFieldAverages(unsigned int i,
                                           Vector & Er, Vector & Ei,
                                           Vector & Br, Vector & Bi,
                                           Vector & Dr, Vector & Di,
                                           Vector & Hr, Vector & Hi)
{
   ...
   {
     MFEM_ASSERT(bravais_ != NULL, "MaxwellBlochWaveEquation: "
...
void
MaxwellBlochWaveEquation::ComputeHomogenizedCoefs()
{
