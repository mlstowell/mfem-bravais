...
#ifndef MFEM_MAXWELL_BLOCH_KRYLOV
#define MFEM_MAXWELL_BLOCH_KRYLOV
...
class MaxwellBlochWaveProjectorKrylov : public Operator
{
public:
...
*/
class MaxwellBlochWaveEquationKrylov
{
public:
   MaxwellBlochWaveEquationKrylov(ParMesh & pmesh, int order);
...
private:
   ...
   Solver   * Precond_;
   MaxwellBlochWaveProjectorKrylov * SubSpaceProj_;
