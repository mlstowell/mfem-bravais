...
#ifndef MFEM_MAXWELL_BLOCH_UNI_AMR
#define MFEM_MAXWELL_BLOCH_UNI_AMR
...
class MaxwellBlochWaveProjectorUniAMR : public Operator
{
public:
...
*/
class MaxwellBlochWaveEquationUniAMR
{
public:
   MaxwellBlochWaveEquationUniAMR(ParMesh & pmesh, int order);
...
private:
   ...
   */
   ...
   Solver   * Precond_;
   MaxwellBlochWaveProjectorUniAMR * SubSpaceProj_;
   ...
   // ParLinearForm * avgHCurl_[3];
   // ParLinearForm * avgHDiv_[3];

   /*
    ParLinearForm * avgHCurl_coskx_[3];
    ParLinearForm * avgHCurl_sinkx_[3];
    ParLinearForm * avgHDiv_coskx_[3];
    ParLinearForm * avgHDiv_sinkx_[3];
   */
...
#endif // MFEM_MAXWELL_BLOCH_UNI_AMR
